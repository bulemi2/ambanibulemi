        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <p className="text-lg text-slate-700 leading-relaxed">
              With a Master's degree in Data Science and over 5 years of hands-on experience, I specialize in transforming raw data into meaningful insights that drive business growth. My expertise spans across various industries including finance, healthcare, and e-commerce.
            </p>
            <p className="text-lg text-slate-700 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div className="text-center p-6 bg-slate-50 rounded-xl">
                <div className="text-3xl font-bold text-data-blue mb-2">150+</div>
